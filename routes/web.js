...
function initRoutes(app){
    ...
    app.post('/register', authController().postrRegister)
    ...
    app.get('/admin/adminorders', admin, adminOrderController().index)

    app.post('/admin/adminorders/status', admin, adminStatusController().update)
