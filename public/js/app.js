...
/* harmony export */   "adminOrder": () => (/* binding */ adminOrder)
/* harmony export */ });
...
function adminOrder(socket) {
  var orderTableBody = document.querySelector('#orderTableBody');
  var orders = [];
  var markup;
  axios__WEBPACK_IMPORTED_MODULE_0___default().get('/admin/adminorders', {
    headers: {
...
if (adminAreaPath.includes('admin')) {
  (0,_admin__WEBPACK_IMPORTED_MODULE_2__.adminOrder)(socket);
